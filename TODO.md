...
## Steps
- [x] Update scraper_api/render.yaml: Set PLAYWRIGHT_BROWSERS_PATH for Render
...
- [x] Update scraper_api/main.py: Fix wishlist refresh to get both Steam and Epic prices
